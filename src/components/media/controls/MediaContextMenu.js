...
import {setMediaMenuContextState} from '../MediaActions'
 ...
 **/
class MediaContextMenu extends React.Component {
    constructor(props) {
        super(props);
...
MediaContextMenu.childContextTypes = {
...
export default connect(populateStateToProp)(injectI18N(MediaContextMenu));